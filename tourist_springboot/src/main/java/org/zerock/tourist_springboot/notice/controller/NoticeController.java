...
public class NoticeController {
  ...
  public void getNoticeList(PageRequestDTO pageRequestDTO, Model model) {
    PageResponseDTO<NoticeDTO> pageResponseDTO = noticeService.searchList(pageRequestDTO);
